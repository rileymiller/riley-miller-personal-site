...
import { githubIconPath, twitterIconPath } from "./icon/paths"
import { css, Global } from "@emotion/core"
import { global, clockwiseRotationAnimation, flex } from "../styles/globals"
...
const RM_Logo = (props: RM_LogoProps) => {
  return (
    <div css={[props.isClockwise && clockwiseRotationAnimation]}>
      <svg width="140" height="140" viewBox="0 0 57 57" xmlns="http://www.w3.org/2000/svg">
    ...
    <>
      ...
      >
        ...
        <footer css={[
          ...
          © {new Date().getFullYear()}, made with ❤️ by riley
        {` `}
        <a target='_blank' href='https://github.com/rileymiller'>
          <Icon size={'16px'} isClockWiseRotation icon={githubIconPath} />
        </a>
        <a target='_blank' href='https://twitter.com/riley_miller00'>
          <Icon size={'16px'} icon={twitterIconPath} color={colors.twitterPrimary} />
        </a>
        </footer>
      </div >
    </>
